            ...
            {["Home", "About", "Membership", "Find Us"].map((link) => {
              ...
              return (
                <a
                  ...
                  className={`flex-1 flex items-center justify-center py-2.5 rounded-full text-base font-medium transition-all duration-500 relative group overflow-hidden ${active
                ...
                {["Home", "About", "Membership", "Find Us"].map((link) => {
                  ...
                  return (
                    <button
                      key={link}
                      onClick={() => scrollTo(id)}
                      className={`text-4xl font-heading italic text-left transition-all duration-300 transform hover:translate-x-4 ${active ? "text-white" : "text-white/50 hover:text-white"
                        }`}
                    >
                      {link}
                    </button>
